...
function WhatsAppIcon({ className }: { className?: string }) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="#25D366" aria-hidden>
        ...
        <CardContent className="space-y-4">
          <div>
            <p style={{color: 'var(--primary-text)'}}>
              ...
              {' '}Join our{' '}
              <a
                  href={APP_CONFIG.WHATSAPP_COMMUNITY_JOIN_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{color: 'var(--accent)', textDecoration: 'underline'}}
                >
          ...
          <div>
            ...
            🍎{' '}
              <a
                href={APP_CONFIG.GAME_SNACK_SIGNUP_URL}
                target="_blank"
                rel="noopener noreferrer"
                style={{color: 'var(--accent)', textDecoration: 'underline'}}
              >
